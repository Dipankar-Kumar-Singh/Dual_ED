...
# Proposed Model 
class Dual_ED_Basic(nn.Module):
	def __init__(self, feats):
		super(Dual_ED_Basic, self).__init__()
		self.name = 'Dual_ED_Basic'
		self.lr = lr
		self.batch = 128
		self.n_feats = feats
		self.n_window = 10
...
# Proposed Model (FCN) + Self Conditioning + Adversarial 
class Dual_ED_Transformer(nn.Module):
	def __init__(self, feats):
		super(Dual_ED_Transformer, self).__init__()
		self.name = 'Dual_ED_Transformer'
		self.lr = lr
		self.batch = 128
		self.n_feats = feats
		self.n_hidden = 8
...
# Proposed Model + Self Conditioning 
class Dual_ED_Adversarial(nn.Module):
	def __init__(self, feats):
		super(Dual_ED_Adversarial, self).__init__()
		self.name = 'Dual_ED_Adversarial'
		self.lr = lr
		self.batch = 128
		self.n_feats = feats
		self.n_window = 10
...
# Proposed Model + Adversarial
class Dual_ED_SelfConditioning(nn.Module):
	def __init__(self, feats):
		super(Dual_ED_SelfConditioning, self).__init__()
		self.name = 'Dual_ED_SelfConditioning'
		self.lr = lr
		self.batch = 128
		self.n_feats = feats
		self.n_window = 10
...
# Proposed Model + Self Conditioning + Adversarial
class Dual_ED(nn.Module):
	def __init__(self, feats):
		super(Dual_ED, self).__init__()
		self.name = 'Dual_ED'
		self.lr = lr
		self.batch = 128
		self.n_feats = feats
